    ...
    $.validationEngineLanguage = {
        newLang: function(){
            $.validationEngineLanguage.allRules = {
				"requiredUsername": { // Add your regex rules here, you can take telephone as an example
					"regex": "none",
					"alertText": "请输入账号",
				...
				"requiredPassword": { // Add your regex rules here, you can take telephone as an example
					"regex": "none",
					"alertText": "请输入密码",
					"alertTextCheckboxMultiple": "Please select an option",
					"alertTextCheckboxe": "This checkbox is required",
				...
				"requiredCaptcha": { // Add your regex rules here, you can take telephone as an example
					"regex": "none",
					"alertText": "请输入验证码",
					"alertTextCheckboxMultiple": "Please select an option",
					"alertTextCheckboxe": "This checkbox is required",
