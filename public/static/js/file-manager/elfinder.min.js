...
(function(e) {
    window.elFinder = function(t, n) {
        ...
        var r = this,
            ...
            L, A = function(t) {
                if (t.init) {
                    ...
                    for (var n in g) {
                        if (g.hasOwnProperty(n) && g[n].mime != "directory" && g[n].phash == v && e.inArray(n, S) === -1) {
                            delete g[n]
                        }
                    }
                }
            ...
            O = function(e) {
                ...
                while (t--) {
                    n = e[t];
                    if (n.name && n.hash && n.mime) {
                        if (!n.phash) {
                            var i = "volume_" + n.name,
                                s = r.i18n(i);
                            if (i != s) {
                                n.i18 = s
                            }
            ...
            M = function(t) {
                ...
                if (c) {
                    e.each(w, function(e, s) {
                        if (s.type == t.type && s.keyCode == n && s.shiftKey == t.shiftKey && s.ctrlKey == i && s.altKey == t.altKey) {
                            t.preventDefault();
                            t.stopPropagation();
                            s.callback(t, r);
                            r.debug("shortcut-exec", e + " : " + s.description)
                        }
                    });
                    if (n == 9 && !e(t.target).is(":input")) {
                        t.preventDefault()
                    }
                }
            },
        ...
        this.UA = function() {
            var e = !document.uniqueID && !window.opera && !window.sidebar && window.localStorage && typeof window.orientation == "undefined";
            return {
        ...
        this.options = e.extend(true, {}, this._options, n || {});
        if (n.ui) {
            this.options.ui = n.ui
        }
        if (n.commands) {
            this.options.commands = n.commands
        }
        if (n.uiOptions && n.uiOptions.toolbar) {
            this.options.uiOptions.toolbar = n.uiOptions.toolbar
        }
        e.extend(this.options.contextmenu, n.contextmenu);
        this.requestType = /^(get|post)$/i.test(this.options.requestType) ? this.options.requestType.toLowerCase() : "get", this.customData = e.isPlainObject(this.options.customData) ? this.options.customData : {};
        this.id = o;
        this.uploadURL = n.urlUpload || n.url;
        this.namespace = u;
        this.lang = this.i18[this.options.lang] && this.i18[this.options.lang].messages ? this.options.lang : "en";
        P = this.lang == "en" ? this.i18["en"] : e.extend(true, {}, this.i18["en"], this.i18[this.lang]);
        this.direction = P.direction;
        this.messages = P.messages;
        this.dateFormat = this.options.dateFormat || P.dateFormat;
        this.fancyFormat = this.options.fancyDateFormat || P.fancyDateFormat;
        this.today = (new Date(_.getFullYear(), _.getMonth(), _.getDate())).getTime() / 1e3;
        this.yesterday = this.today - 86400;
        D = this.options.UTCDate ? "UTC" : "";
        this.getHours = "get" + D + "Hours";
        this.getMinutes = "get" + D + "Minutes";
        this.getSeconds = "get" + D + "Seconds";
        this.getDate = "get" + D + "Date";
        this.getDay = "get" + D + "Day";
        this.getMonth = "get" + D + "Month";
        this.getFullYear = "get" + D + "FullYear";
        ...
        this.sortRules = e.extend(true, {}, this._sortRules, this.options.sortsRules);
        e.each(this.sortRules, function(e, t) {
            if (typeof t != "function") {
                delete r.sortRules[e]
            }
        });
        this.compare = e.proxy(this.compare, this);
        ...
        this.draggable = {
            ...
            drag: function(e, t) {
                if (!t.helper.data("locked")) {
                    t.helper.toggleClass("elfinder-drag-helper-plus", e.shiftKey || e.ctrlKey || e.metaKey)
                }
            },
            start: function(t, n) {
                ...
                while (i--) {
                    s = r[i];
                    if (g[s].locked) {
                        n.helper.addClass("elfinder-drag-helper-plus").data("locked", true);
                        break
                    }
                }
            },
            ...
            helper: function(t, n) {
                ...
                u = i.is("." + r.res("class", "cwdfile")) ? r.selected() : [r.navId2Hash(i.attr("id"))];
                s.append(o(g[u[0]].mime)).data("files", u).data("locked", false);
                if ((a = u.length) > 1) {
                    s.append(o(g[u[a - 1]].mime) + '<span class="elfinder-drag-num">' + a + "</span>")
                }
                return s
            }
        };
        this.droppable = {
            ...
            drop: function(t, n) {
                ...
                if (i.is("." + r.res(u, "cwd"))) {
                    f = v
                } else if (i.is("." + r.res(u, "cwdfile"))) {
                    f = i.attr("id")
                } else if (i.is("." + r.res(u, "navdir"))) {
                    f = r.navId2Hash(i.attr("id"))
                }
                a = s.length;
                while (a--) {
                    c = s[a];
                    c != f && g[c].phash != f && o.push(c)
                }
                if (o.length) {
                    n.helper.hide();
                    r.clipboard(o, !(t.ctrlKey || t.shiftKey || t.metaKey || n.helper.data("locked")));
                    r.exec("paste", f);
                    r.trigger("drop", {
                        files: s
                    })
        ...
        this.root = function(e) {
            ...
            while (n in g && g.hasOwnProperty(n)) {
                t = g[n];
                if (!t.phash && !t.mime == "directory" && t.read) {
                    return t.hash
                }
            }
            return ""
        ...
        this.path2array = function(e, t) {
            var n, r = [];
            while (e && (n = g[e]) && n.hash) {
                r.unshift(t && n.i18 ? n.i18 : n.name);
                e = n.phash
            }
            return r
        };
        this.path = function(e, t) {
            return g[e] && g[e].path ? g[e].path : this.path2array(e, t).join(m.separator)
        };
        this.url = function(t) {
            var n = g[t];
            if (!n || !n.read) {
            ...
            if (m.url) {
                return m.url + e.map(this.path2array(t), function(e) {
            ...
            return this.options.url + (this.options.url.indexOf("?") === -1 ? "?" : "&") + e.param(r, true)
        };
        this.tmb = function(e) {
            var t = g[e],
                n = t && t.tmb && t.tmb != 1 ? m["tmbUrl"] + t.tmb : "";
            if (n && (this.UA.Opera || this.UA.IE)) {
        ...
        this.fileByName = function(e, t) {
            var n;
            for (n in g) {
                if (g.hasOwnProperty(n) && g[n].phash == t && g[n].name == e) {
                    return g[n]
                }
            }
        };
        ...
        this.request = function(t) {
            var n = this,
                ...
                p = function(t) {
                    t.warning && n.error(t.warning);
                    o == "open" && A(e.extend(true, {}, t));
                    t.removed && t.removed.length && n.remove(t);
                    t.added && t.added.length && n.add(t);
                    t.changed && t.changed.length && n.change(t);
                    n.trigger(o, t);
                    t.sync && n.sync()
                },
                d = function(e, t) {
                    ...
                    switch (t) {
                        ...
                        default:
                            if (e.status == 403) {
                                n = ["errConnect", "errAccess"]
                            } else if (e.status == 404) {
                                n = ["errConnect", "errNotFound"]
                            } else {
                                n = "errConnect"
                            }
                    }
                ...
                v = function(t) {
                    ...
                    if (!t) {
                        return i.reject(["errResponse", "errDataEmpty"], g)
                    } else if (!e.isPlainObject(t)) {
                        return i.reject(["errResponse", "errDataNotJSON"], g)
                    } else if (t.error) {
                        return i.reject(t.error, g)
                    } else if (!n.validResponse(o, t)) {
                        return i.reject("errResponse", g)
                    }
                    t = n.normalize(t);
                    if (!n.api) {
                        n.api = t.api || 1;
                    ...
                    if (t.options) {
                        m = e.extend({}, m, t.options)
                    }
                    if (t.netDrivers) {
                        n.netDrivers = t.netDrivers
                    }
                    i.resolve(t);
                    t.debug && n.debug("backend-debug", t.debug)
                },
                g, y;
            a && i.done(p);
            i.fail(function(e) {
                if (e) {
                    u ? n.error(e) : n.debug("error", n.i18n(e))
                }
            });
            if (!o) {
                return i.reject("errCmdReq")
            }
            if (c) {
                i.fail(function(e) {
                    e && n.sync()
            ...
            delete t.preventFail;
            g = this.transport.send(t).fail(d).done(v);
            if (o == "open") {
                x.unshift(g);
                i.always(function() {
                    var t = e.inArray(g, x);
        ...
        this.diff = function(t) {
            ...
            e.each(i, function(t, r) {
                var u = g[r],
                    a = u.phash;
                if (a && u.mime == "directory" && e.inArray(a, i) === -1 && n[a] && !o(a)) {
                    s.push(n[a])
                }
            });
            return {
        ...
        this.sync = function() {
            var t = this,
                ...
                i = {
                    data: {
                        cmd: "tree",
                        target: v == this.root() ? v : this.file(v).phash
                    },
                    preventDefault: true
                };
            e.when(this.request(r), this.request(i)).fail(function(e) {
                n.reject(e);
                e && t.request({
                    data: {
                        cmd: "open",
                ...
                i.added.push(e.cwd);
                i.removed.length && t.remove(i);
                i.added.length && t.add(i);
                i.changed.length && t.change(i);
                return n.resolve(i)
            });
            return n
        };
        ...
        this.trigger = function(t, n) {
            ...
            if (r.length) {
                ...
                for (i = 0; i < r.length; i++) {
                    t.data = e.extend(true, {}, n);
                    try {
                        if (r[i](t, this) === false || t.isDefaultPrevented()) {
        ...
        this.shortcut = function(t) {
            ...
            if (this.options.allowShortcuts && t.pattern && e.isFunction(t.callback)) {
                ...
                for (s = 0; s < n.length; s++) {
                    r = n[s];
                    o = r.split("+");
                    i = (i = o.pop()).length == 1 ? i > 0 ? i : i.charCodeAt(0) : e.ui.keyCode[i];
                    if (i && !w[r]) {
                        w[r] = {
                            keyCode: i,
        ...
        this.clipboard = function(t, n) {
            ...
            if (t !== void 0) {
                E.length && this.trigger("unlockfiles", {
                    files: r()
                });
                S = [];
                E = e.map(t || [], function(e) {
                    var t = g[e];
                    if (t) {
                        S.push(e);
                        return {
        ...
        this.isCommandEnabled = function(t) {
            return this._commands[t] ? e.inArray(t, m.disabled) === -1 : false
        };
        ...
        this.resize = function(e, n) {
            t.css("width", e).height(n).trigger("resize");
            this.trigger("resize", {
                width: t.width(),
                height: t.height()
            })
        ...
        this.destroy = function() {
            if (t && t[0].elfinder) {
                ...
                r.trigger = function() {};
                t.children().remove();
                t.append(i.contents()).removeClass(this.cssClass).attr("style", s);
                t[0].elfinder = null;
                if (L) {
                    clearInterval(L)
                }
        ...
        if (!(e.fn.selectable && e.fn.draggable && e.fn.droppable)) {
        ...
        if (typeof this.transport.send != "function") {
            this.transport.send = function(t) {
                return e.ajax(t)
            }
        }
        if (this.transport.upload == "iframe") {
            this.transport.upload = e.proxy(this.uploads.iframe, this)
        } else if (typeof this.transport.upload == "function") {
            this.dragUpload = !! this.options.dragUploadAllow
        } else if (this.xhrUpload && !! this.options.dragUploadAllow) {
            this.transport.upload = e.proxy(this.uploads.xhr, this);
        ...
        this.enable(function() {
            if (!c && r.visible() && r.ui.overlay.is(":hidden")) {
                c = true;
                e("texarea:focus,input:focus,button").blur();
                t.removeClass("elfinder-disabled")
            }
        }).disable(function() {
            h = c;
            c = false;
            t.addClass("elfinder-disabled")
        }).open(function() {
            y = []
        }).select(function(t) {
            ...
            e.each(t.data.changed || [], function(t, n) {
                var r = n.hash;
                if (g[r].width && !n.width || g[r].height && !n.height) {
                    g[r].width = undefined;
                    g[r].height = undefined
                }
            ...
            var n = t.data.removed || [],
                ...
                i = function(t) {
                    var n = g[t];
                    if (n) {
                        if (n.mime == "directory" && n.dirs) {
                            e.each(g, function(e, n) {
                                n.phash == t && i(e)
                            })
                        }
                        delete g[t]
        ...
        this._commands = {};
        if (!e.isArray(this.options.commands)) {
            this.options.commands = []
        }
        e.each(["open", "reload", "back", "forward", "up", "home", "info", "quicklook", "getfile", "help"], function(t, n) {
            e.inArray(n, r.options.commands) === -1 && r.options.commands.push(n)
        });
        e.each(this.options.commands, function(t, n) {
            var i = r.commands[n];
            if (e.isFunction(i) && !r._commands[n]) {
                i.prototype = T;
                r._commands[n] = new i;
                r._commands[n].setup(n, r.options.commandsOptions[n] || {})
            }
        });
        ...
        e.each(this.options.ui || [], function(n, i) {
            ...
            if (!r.ui[i] && e.fn[s]) {
                r.ui[i] = e("<" + (o.tag || "div") + "/>").appendTo(t)[s](r, o)
            }
        });
        t[0].elfinder = this;
        this.options.resizable && e.fn.resizable && t.resizable({
            handles: "se",
            minWidth: 300,
            minHeight: 200
        });
        ...
        if (this.options.height) {
            C = parseInt(this.options.height)
        }
        r.resize(N, C);
        e(document).bind("click." + this.namespace, function(n) {
        ...
        this.trigger("init").request({
            ...
            r.trigger("fail").disable().lastDir("");
            b = {};
            w = {};
            e(document).add(t).unbind("." + this.namespace);
            r.trigger = function() {}
        }).done(function(t) {
            r.load().debug("api", r.api);
            t = e.extend(true, {}, t);
            A(t);
            r.trigger("open", t)
        });
    ...
    elFinder.prototype = {
        ...
        rules: {
            defaults: function(t) {
                if (!t || t.added && !e.isArray(t.added) || t.removed && !e.isArray(t.removed) || t.changed && !e.isArray(t.changed)) {
                    return false
                }
                return true
            },
        ...
        parseUploadData: function(t) {
            ...
            if (!this.validResponse("upload", n)) {
                return {
                    error: ["errResponse"]
                }
            }
            n = this.normalize(n);
            n.removed = e.map(n.added || [], function(e) {
                return e.hash
            });
            return n
        },
            ...
            iframe: function(t, n) {
                var r = n ? n : this,
                    ...
                    s = e.Deferred().fail(function(e) {
                        ...
                        e.warning && r.error(e.warning);
                        e.removed && r.remove(e);
                        e.added && r.add(e);
                        e.changed && r.change(e);
                        r.trigger("upload", e);
                        e.sync && r.sync()
                    }),
                    ...
                    f = function() {
                        ...
                        setTimeout(function() {
                            a && e('<iframe src="javascript:false;"/>').appendTo(u);
                            u.remove();
                            l.remove()
                        }, 100)
                    },
                    l = e('<iframe src="' + (a ? "javascript:false;" : "about:blank") + '" name="' + o + '" style="position:absolute;left:-1000px;top:-1000px" />').bind("load", function() {
                        l.unbind("load").bind("load", function() {
                            ...
                            f();
                            e.error ? s.reject(e.error) : s.resolve(e)
                        });
                        ...
                        if (r.options.iframeTimeout > 0) {
                            d = setTimeout(function() {
                                f();
                                s.reject([errors.connect, errors.timeout])
                            }, r.options.iframeTimeout)
                        }
                        u.submit()
                    }),
                    c, h, p, d;
                if (i && e(i).is(":file") && e(i).val()) {
                    u.append(i)
                } else {
                    return s.reject()
                }
                c = i.files ? i.files.length : 1;
                u.append('<input type="hidden" name="' + (r.newAPI ? "target" : "current") + '" value="' + r.cwd().hash + '"/>').append('<input type="hidden" name="html" value="1"/>').append(e(i).attr("name", "upload[]"));
            ...
            xhr: function(t, n) {
                ...
                s.addEventListener("load", function() {
                    var e = s.status,
                        t;
                    if (e > 500) {
                        return i.reject("errResponse")
                    }
                    if (e != 200) {
                        return i.reject("errConnect")
                    }
                    if (s.readyState != 4) {
                        return i.reject(["errConnect", "errTimeout"])
                    }
                    if (!s.responseText) {
                        return i.reject(["errResponse", "errDataEmpty"])
                    }
                    t = r.parseUploadData(s.responseText);
                    t.error ? i.reject(t.error) : i.resolve(t)
                }, false);
                s.upload.addEventListener("progress", function(e) {
                    var t = f,
                        n;
                    if (e.lengthComputable) {
                        n = parseInt(e.loaded * 100 / e.total);
                        if (n > 0 && !h) {
                            h = c()
                        }
                        if (n - t > 4) {
                ...
                s.open("POST", r.uploadURL, true);
                o.append("cmd", "upload");
                o.append(r.newAPI ? "target" : "current", r.cwd().hash);
                e.each(r.options.customData, function(e, t) {
                    o.append(e, t)
                });
                e.each(r.options.onlyMimes, function(e, t) {
        ...
        cookie: function(t, n) {
            ...
            if (n === void 0) {
                if (document.cookie && document.cookie != "") {
                    ...
                    for (o = 0; o < s.length; o++) {
                        s[o] = e.trim(s[o]);
                        if (s[o].substring(0, t.length) == t) {
                            return decodeURIComponent(s[o].substring(t.length))
                        }
                    }
                }
                return ""
            }
            i = e.extend({}, this.options.cookie);
            if (n === null) {
                n = "";
                i.expires = -1
            }
            if (typeof i.expires == "number") {
                r = new Date;
                r.setTime(r.getTime() + i.expires * 864e5);
                i.expires = r
            }
            document.cookie = t + "=" + encodeURIComponent(n) + "; expires=" + i.expires.toUTCString() + (i.path ? "; path=" + i.path : "") + (i.domain ? "; domain=" + i.domain : "") + (i.secure ? "; secure" : "");
            return n
        },
        lastDir: function(e) {
        ...
        normalize: function(t) {
            var n = function(e) {
                if (e && e.hash && e.name && e.mime) {
                    if (e.mime == "application/x-empty") {
                        e.mime = "text/plain"
                    }
                    return e
                }
                return null;
                return e && e.hash && e.name && e.mime ? e : null
            };
            if (t.files) {
                t.files = e.map(t.files, n)
            }
            if (t.tree) {
                t.tree = e.map(t.tree, n)
            }
            if (t.added) {
                t.added = e.map(t.added, n)
            }
            if (t.changed) {
                t.changed = e.map(t.changed, n)
            }
            if (t.api) {
                t.init = true
            }
        ...
        setSort: function(e, t, n) {
            this.storage("sortType", this.sortType = this.sortRules[e] ? e : "name");
            this.storage("sortOrder", this.sortOrder = /asc|desc/.test(t) ? t : "asc");
            this.storage("sortStickFolders", (this.sortStickFolders = !! n) ? 1 : "");
        ...
        _sortRules: {
            ...
            size: function(e, t) {
                ...
                return (parseInt(e.size) || 0) > (parseInt(t.size) || 0) ? 1 : -1
            },
            kind: function(e, t) {
        ...
        compare: function(e, t) {
            ...
            l = i ? u(e, t) : u(t, e);
            return r != "name" && l == 0 ? l = i ? o.name(e, t) : o.name(t, e) : l
        },
        ...
        notify: function(t) {
            var n = t.type,
                ...
                o = '<div class="elfinder-notify elfinder-notify-{type}"><span class="elfinder-dialog-icon elfinder-dialog-icon-{type}"/><span class="elfinder-notify-msg">{msg}</span> <span class="elfinder-notify-cnt"/><div class="elfinder-notify-progressbar">Please wait...</div>',
                u = t.cnt,
            ...
            if (!s.length) {
                s = e(o.replace(/\{type\}/g, n).replace(/\{msg\}/g, r)).appendTo(i).data("cnt", 0);
                if (a) {
                    s.data({
                        progress: 0,
                        total: 0
            ...
            f = u + parseInt(s.data("cnt"));
            if (f > 0) {
                !t.hideCnt && s.children(".elfinder-notify-cnt").text("(" + f + ")");
                i.is(":hidden") && i.elfinderdialog("open");
                s.data("cnt", f);
                if (a < 100 && (l = s.data("total")) >= 0 && (c = s.data("progress")) >= 0) {
                    l = u + parseInt(s.data("total"));
                    c = a + c;
                    a = parseInt(c / l);
                    s.data({
                        progress: c,
                ...
                s.remove();
                !i.children().length && i.elfinderdialog("close")
            }
            return this
        },
        confirm: function(t) {
            var n = false,
                ...
                s, o;
            if (t.reject) {
                r.buttons[this.i18n(t.reject.label)] = function() {
                    t.reject.callback( !! (o && o.prop("checked")));
                    n = true;
                    e(this).elfinderdialog("close")
                }
            }
            r.buttons[this.i18n(t.accept.label)] = function() {
                t.accept.callback( !! (o && o.prop("checked")));
                n = true;
                e(this).elfinderdialog("close")
            };
            ...
            if (t.all) {
                ...
                r.create = function() {
                    o = e('<input type="checkbox" />');
                    e(this).next().children().before(e("<label>" + i + "</label>").prepend(o))
                };
                r.open = function() {
                    var t = e(this).next(),
                        n = parseInt(t.children(":first").outerWidth() + t.children(":last").outerWidth());
                    if (n > parseInt(t.width())) {
                        e(this).closest(".elfinder-dialog").width(n + 30)
                    }
                }
            }
            return this.dialog('<span class="elfinder-dialog-icon elfinder-dialog-icon-confirm"/>' + this.i18n(t.text), r)
        },
        uniqueName: function(e, t) {
            ...
            e = this.i18n(e);
            t = t || this.cwd().hash;
            if ((i = e.indexOf(".txt")) != -1) {
                r = ".txt";
                e = e.substr(0, i)
            }
            s = e + r;
            if (!this.fileByName(s, t)) {
                return s
            }
            while (n < 1e4) {
                s = e + " " + ++n + r;
        ...
        mime2class: function(e) {
            ...
            e = e.split("/");
            return t + e[0] + (e[0] != "image" && e[1] ? " " + t + e[1].replace(/(\.|\+)/g, "-") : "")
        },
        mime2kind: function(e) {
            ...
            if (e.alias) {
                ...
                if (t.indexOf("text") === 0) {
                    ...
                    n = "Video"
                } else if (t.indexOf("application") === 0) {
                    n = "App"
                } else {
                    n = t
                }
        ...
        formatDate: function(e, t) {
            ...
            if (n.options.clientFormatDate && t > 0) {
                i = new Date(t * 1e3);
                c = i[n.getHours]();
                h = c > 12 ? c - 12 : c;
                p = i[n.getMinutes]();
                ...
                f = i[n.getMonth]() + 1;
                l = i[n.getFullYear]();
                s = t >= this.yesterday ? this.fancyFormat : this.dateFormat;
                o = s.replace(/[a-z]/gi, function(e) {
                    switch (e) {
                        case "d":
                            return u > 9 ? u : "0" + u;
                        case "j":
                ...
                return t >= this.yesterday ? o.replace("$1", this.i18n(t >= this.today ? "Today" : "Yesterday")) : o
            } else if (e.date) {
                return e.date.replace(/([a-z]+)\s/i, function(e, t) {
                    return n.i18n(t) + " "
                })
            }
            return n.i18n("dateUnknown")
        },
        ...
        formatPermissions: function(e) {
            var t = [];
            e.read && t.push(this.i18n("read"));
            e.write && t.push(this.i18n("write"));
            return t.length ? t.join(" " + this.i18n("and") + " ") : this.i18n("noaccess")
        },
        formatSize: function(e) {
            ...
            e = e / t;
            return (e > 0 ? t >= 1048576 ? e.toFixed(2) : Math.round(e) : 0) + " " + n
        },
        navHash2Id: function(e) {
            return "nav-" + e
        },
        navId2Hash: function(e) {
            return typeof e == "string" ? e.substr(4) : false
        },
        log: function(e) {
        ...
        debug: function(t, n) {
            ...
            if (r == "all" || r === true || e.isArray(r) && e.inArray(t, r) != -1) {
                window.console && window.console.log && window.console.log("elfinder debug: [" + t + "] [" + this.id + "]", n)
            }
            return this
        },
        time: function(e) {
    ...
    e.fn.elfinder = function(e) {
        ...
        return this.each(function() {
            ...
            if (!this.elfinder) {
                new elFinder(this, typeof e == "object" ? e : {})
            }
            switch (t) {
                case "close":
                case "hide":
    ...
    elFinder.prototype.history = function(t) {
        var n = this,
            ...
            u = function(u) {
                if (u && n.canForward() || !u && n.canBack()) {
                    r = false;
                    return t.exec("open", i[u ? ++s : --s]).fail(o)
                }
    ...
    elFinder.prototype.command = function(t) {
        ...
        this.setup = function(t, n) {
            var r = this,
                ...
                s, o;
            this.name = t;
            this.title = i.messages["cmd" + t] ? i.i18n("cmd" + t) : t, this.options = e.extend({}, this.options, n);
            this.listeners = [];
            ...
            for (s = 0; s < this.shortcuts.length; s++) {
                o = this.shortcuts[s];
                o.callback = e.proxy(o.callback ||
                    function() {
                        this.exec()
                    }, this);
                !o.description && (o.description = this.title);
                i.shortcut(o)
            }
            if (this.disableOnSearch) {
                i.bind("search searchend", function(e) {
                    r._disabled = e.type == "search";
                    r.update(void 0, r.value)
                })
            }
            this.init()
        };
        ...
        this.update = function(e, t) {
            ...
            if (this._disabled) {
                ...
                this.state = e !== void 0 ? e : this.getstate()
            }
            this.value = t;
            if (n != this.state || r != this.value) {
                this.change()
            }
        };
    ...
    elFinder.prototype.resources = {
        ...
        mixin: {
            make: function() {
                var t = this.fm,
                    ...
                    l = e('<input type="text"/>').keydown(function(t) {
                        ...
                        if (t.keyCode == e.ui.keyCode.ESCAPE) {
                            i.reject()
                        } else if (t.keyCode == e.ui.keyCode.ENTER) {
                            l.blur()
                        }
                        ...
                        if (u.length) {
                            if (!r) {
                                return i.reject("errInvName")
                            }
                            if (t.fileByName(r, o)) {
                                return i.reject(["errExists", r])
                            }
                            u.html(t.escape(r));
                            t.lockfiles({
                                files: [s]
                ...
                if (this.disabled() || !f.length) {
                    return i.reject()
                }
                t.disable();
                f.find(".elfinder-cwd-filename").empty("").append(l.val(a.name));
                l.select().focus();
                return i
            }
        }
    ...
    e.fn.dialogelfinder = function(t) {
        ...
        this.not(".elfinder").each(function() {
            var i = e(document),
                ...
                o = e('<a href="#" class="dialogelfinder-drag-close ui-corner-all"><span class="ui-icon ui-icon-closethick">&times;</span></a>').appendTo(s).click(function(e) {
                    e.preventDefault();
                    u.dialogelfinder("close")
                }),
            ...
            u.width(parseInt(u.width()) || 840).data(r, !! t.destroyOnClose).find(".elfinder-toolbar").removeClass("ui-corner-top");
            t.position && u.data(n, t.position);
            t.autoOpen !== false && e(this).dialogelfinder("open")
        });
        if (t == "open") {
            var i = e(this),
                s = i.data(n) || {
                ...
                o = 100;
            if (i.is(":hidden")) {
                e("body").find(":visible").each(function() {
                    var t = e(this),
                        n;
                    if (this !== i[0] && t.css("position") == "absolute" && (n = parseInt(t.zIndex())) > o) {
                        o = n + 1
                    }
                });
                i.zIndex(o).css(s).show().trigger("resize");
                setTimeout(function() {
            ...
            var i = e(this);
            if (i.is(":visible")) { !! i.data(r) ? i.elfinder("destroy").remove() : i.elfinder("close")
            }
        } else if (t == "instance") {
            return e(this).getElFinder()
        }
        return this
    };
    ...
    e.fn.elfinderbutton = function(t) {
        return this.each(function() {
            var n = "class",
                ...
                f, l = e(this).addClass("ui-state-default elfinder-button tooltips").attr("title", t.title).append('<span class="elfinder-button-icon elfinder-button-icon-' + t.name + '"/>').hover(function(e) {
                    !l.is("." + i) && l[e.type == "mouseleave" ? "removeClass" : "addClass"](o)
                }).click(function(e) {
                    if (!l.is("." + i)) {
                        if (f && t.variants.length > 1) {
                            f.is(":hidden") && t.fm.getUI().click();
                            e.stopPropagation();
                            f.slideToggle(100)
                        } else {
                            t.exec()
            ...
            if (e.isArray(t.variants)) {
                l.addClass("elfinder-menubutton");
                f = e('<div class="ui-widget ui-widget-content elfinder-button-menu ui-corner-all"/>').hide().appendTo(l).zIndex(12 + l.zIndex()).delegate("." + u, "hover", function() {
                    e(this).toggleClass(o)
                }).delegate("." + u, "click", function(n) {
                    n.preventDefault();
                    n.stopPropagation();
                    l.removeClass(o);
                    t.exec(t.fm.selected(), e(this).data("value"))
                });
                t.fm.bind("disable select", c).getUI().click(c);
                t.change(function() {
                    f.html("");
                    e.each(t.variants, function(n, r) {
            ...
            t.change(function() {
                if (t.disabled()) {
                    l.removeClass(s + " " + o).addClass(i)
                } else {
                    l.removeClass(i);
                    l[t.active() ? "addClass" : "removeClass"](s)
                }
            }).change()
        })
    };
    e.fn.elfindercontextmenu = function(t) {
        return this.each(function() {
            var n = e(this).addClass("ui-helper-reset ui-widget ui-state-default ui-corner-all elfinder-contextmenu fadeIn animated elfinder-contextmenu-" + t.direction).hide().appendTo("body").delegate(".elfinder-contextmenu-item", "mouseenter mouseleave", function() {
                ...
                u = function(i, s) {
                    ...
                    p[r] = parseInt(n.width());
                    n.find(".elfinder-contextmenu-sub").css(p)
                },
                a = function() {
                    n.hide().empty()
                },
                f = function(r, s) {
                    ...
                    e.each(i[r] || [], function(r, i) {
                        var f, l, c;
                        if (i == "|" && u) {
                            n.append('<div class="elfinder-contextmenu-separator"/>');
                            u = false;
                            return
                        }
                        f = t.command(i);
                        if (f && f.getstate(s) != -1) {
                            if (f.variants) {
                                ...
                                l = o(f.title, f.name, function() {});
                                c = e('<div class="ui-corner-all elfinder-contextmenu-sub"/>').appendTo(l.append('<span class="elfinder-contextmenu-arrow"/>'));
                                l.addClass("elfinder-contextmenu-group").hover(function() {
                                    c.toggle()
                                });
                ...
                l = function(t) {
                    e.each(t, function(e, t) {
                        var r;
                        if (t.label && typeof t.callback == "function") {
                            r = o(t.label, t.icon, function() {
                                a();
                                t.callback()
                            });
                            n.append(r)
    ...
    e.fn.elfindercwd = function(t, n) {
        this.not(".elfinder-cwd").each(function() {
            var r = t.viewType == "list",
                ...
                C = function(e) {
                    e.name = t.escape(e.name);
                    return S[r ? "row" : "icon"].replace(/\{([a-z]+)\}/g, function(t, n) {
                ...
                L = function(t, n) {
                    ...
                    var i = e.ui.keyCode,
                        ...
                        l, c, d, v, m;
                    if (a.length) {
                        l = a.filter(u ? ":first" : ":last");
                        d = g(l, u ? "prev" : "next");
                        if (!d.length) {
                            c = l
                        } else if (r || t == i.LEFT || t == i.RIGHT) {
                            c = d
                        } else {
                            v = l.position().top;
                            m = l.position().left;
                        ...
                        c = K.find("[id]:not(." + p + "):not(.elfinder-cwd-parent):" + (u ? "last" : "first"))
                    }
                    if (c && c.length && !c.is(".elfinder-cwd-parent")) {
                        if (n) {
                            c = l.add(l[u ? "prevUntil" : "nextUntil"]("#" + c.attr("id"))).add(c)
                        } else {
                            a.trigger(o)
                        }
                        c.trigger(s);
                        H(c.filter(u ? ":first" : ":last"));
                        P()
                    }
                },
                A = [],
                ...
                M = function() {
                    var n = t.cwd().hash;
                    K.find("[id]:not(." + h + "):not(.elfinder-cwd-parent)").trigger(s);
                    A = e.map(t.files(), function(e) {
                ...
                I = function() {
                    var n = [],
                        ...
                        a = K.find("[id]:last"),
                        f = !a.length,
                        l = r ? K.children("table").children("tbody") : K,
                        c;
                    if (!B.length) {
                        return Q.unbind(F)
                    }
                    while ((!a.length || a.position().top <= Q.height() + Q.scrollTop() + t.options.showThreshold) && (c = B.splice(0, t.options.showFiles)).length) {
                        n = e.map(c, function(e) {
                            if (e.hash && e.name) {
                                if (e.mime == "directory") {
                                    i = true
                                }
                                if (e.tmb) {
                                    e.tmb === 1 ? o.push(e.hash) : u[e.hash] = e.tmb
                                }
                                return C(e)
                            }
                            return null
                    ...
                    i && R();
                    if (A.length) {
                        l.find("[id]:not(." + h + "):not(.elfinder-cwd-parent)").each(function() {
                            var t = this.id;
                            e.inArray(t, A) !== -1 && e(this).trigger(s)
                        })
                    }
                },
                ...
                R = function() {
                    setTimeout(function() {
                        K.find(".directory:not(." + v + ",.elfinder-na,.elfinder-ro)").droppable(t.droppable)
                    }, 20)
                },
                U = function(n) {
                ...
                W = function(e) {
                    var n = r ? K.find("tbody") : K,
                        i = e.length,
                        s = [],
                        o = {},
                        u = false,
                        a = function(e) {
                            var n = K.find("[id]:first"),
                                r;
                            while (n.length) {
                                r = t.file(n.attr("id"));
                                if (!n.is(".elfinder-cwd-parent") && r && t.compare(e, r) < 0) {
                                    return n
                                }
                                n = n.next("[id]")
                            }
                ...
                J = function(i, s) {
                    ...
                    K.removeClass("elfinder-cwd-view-icons elfinder-cwd-view-list").addClass("elfinder-cwd-view-" + (r ? "list" : "icons"));
                    Q[r ? "addClass" : "removeClass"]("elfinder-cwd-wrapper-list");
                    r && K.html('<table><thead><tr class="ui-state-default"><td >' + V.name + "</td><td>" + V.perm + "</td><td>" + V.mod + "</td><td>" + V.size + "</td><td>" + V.kind + "</td></tr></thead><tbody/></table>");
                    B = e.map(i, function(e) {
                        return s || e.phash == o ? e : null
                    });
                    B = t.sortFiles(B);
                    Q.bind(F, I).trigger(F);
                    o = t.cwd().phash;
                    if (n.oldSchool && o && !w) {
                        var a = e.extend(true, {}, t.file(o), {
                            name: "..",
                            mime: "directory"
                        });
                        a = e(C(a)).addClass("elfinder-cwd-parent").bind("mousedown click mouseup touchstart touchmove touchend dblclick mouseenter", function(e) {
                            e.preventDefault();
                            e.stopPropagation()
                        }).dblclick(function() {
                            t.exec("open", this.id)
                        });
                        (r ? K.find("tbody") : K).prepend(a)
                    }
                },
                K = e(this).addClass("ui-helper-clearfix elfinder-cwd").attr("unselectable", "on").delegate(c, "click." + t.namespace, function(n) {
                    var r = this.id ? e(this) : e(this).parents("[id]:first"),
                        i = r.prevAll("." + h + ":first"),
                        u = r.nextAll("." + h + ":first"),
                        a = i.length,
                        f = u.length,
                    ...
                    if (n.shiftKey && (a || f)) {
                        l = a ? r.prevUntil("#" + i.attr("id")) : r.nextUntil("#" + u.attr("id"));
                        l.add(r).trigger(s)
                    } else if (n.ctrlKey || n.metaKey) {
                        r.trigger(r.is("." + h) ? o : s)
                    } else {
                        if (e(this).data("touching") && r.is("." + h)) {
                            e(this).data("touching", null);
                            t.dblclick({
                                file: this.id
                            });
                            _()
                ...
                }).delegate(c, "touchstart." + t.namespace, function(t) {
                    e(this).data("touching", true);
                    var n = this.id ? e(this) : e(this).parents("[id]:first"),
                        r = n.prevAll("." + h + ":first").length + n.nextAll("." + h + ":first").length;
                    e(this).data("longtap", setTimeout(function() {
                        n.trigger(n.is("." + h) ? o : s);
                        P();
                        if (r == 0 && n.is("." + h)) {
                            n.trigger("click");
                            P()
                    ...
                    var i = e(this),
                        s = r ? i : i.children();
                    if (!i.is("." + y) && !s.is("." + d + ",." + p)) {
                        s.draggable(t.draggable)
                    }
                }).delegate(c, s, function(t) {
                    var n = e(this),
                        r = n.attr("id");
                    if (!k && !n.is("." + p)) {
                        n.addClass(h).children().addClass(m);
                        if (e.inArray(r, A) === -1) {
                            A.push(r)
                        }
                    }
                    ...
                    var n = e(this),
                        ...
                        i;
                    if (!k) {
                        e(this).removeClass(h).children().removeClass(m);
                        i = e.inArray(r, A);
                        if (i !== -1) {
                            A.splice(i, 1)
                        }
                    ...
                    t.is("." + v) && t.droppable("disable");
                    n.is("." + d) && n.draggable("disable");
                    !r && n.removeClass(p)
                }).delegate(c, a, function() {
                    var t = e(this).removeClass(p),
                        n = r ? t : t.children();
                    t.is("." + v) && t.droppable("enable");
                    n.is("." + d) && n.draggable("enable")
                    ...
                    K.scrollTop(0)
                }).bind("unselectall", _).bind("selectfile", function(e, t) {
                    K.find("#" + t).trigger(s);
                    P()
                }),
                Q = e('<div class="elfinder-cwd-wrapper"/>').bind("contextmenu", function(e) {
                    e.preventDefault();
                    t.trigger("contextmenu", {
                        type: "cwd",
                        targets: [t.cwd().hash],
                ...
                G = function() {
                    var t = 0;
                    Q.siblings(".elfinder-panel:visible").each(function() {
                        t += e(this).outerHeight(true)
                    });
                    Q.height(Z.height() - t)
                },
                Y = e(this).parent().resize(G),
                Z = Y.children(".elfinder-workzone").append(Q.append(this));
            if (t.dragUpload) {
                Q[0].addEventListener("dragenter", function(e) {
                    e.preventDefault();
                    e.stopPropagation();
                    Q.addClass(g)
                }, false);
                Q[0].addEventListener("dragleave", function(e) {
                    e.preventDefault();
                    e.stopPropagation();
                    e.target == K[0] && Q.removeClass(g)
                }, false);
                Q[0].addEventListener("dragover", function(e) {
                    e.preventDefault();
                    e.stopPropagation()
                }, false);
                Q[0].addEventListener("drop", function(e) {
                    e.preventDefault();
                    Q.removeClass(g);
                    e.dataTransfer && e.dataTransfer.files && e.dataTransfer.files.length && t.exec("upload", {
                        files: e.dataTransfer.files
                    })
                }, false)
            }
            t.bind("open", function(e) {
                J(e.data.files)
            }).bind("search", function(e) {
                E = e.data.files;
                J(E, true)
                ...
                var r = t.cwd().hash,
                    ...
                    s;
                if (w) {
                    e.each(n.data.changed || [], function(t, n) {
                        X([n.hash]);
                        if (n.name.indexOf(w) !== -1) {
                            W([n]);
                            e.inArray(n.hash, i) !== -1 && O(n.hash)
                        }
                    })
                } else {
                ...
                K.css("height", "auto");
                if (K.outerHeight(true) < Q.height()) {
                    K.height(Q.height() - (K.outerHeight(true) - K.height()) - 2)
                }
                ...
                if (n.is(c)) {
                    if (!n.is("." + h)) {
                        !(r.ctrlKey || r.metaKey || r.shiftKey) && _();
                        n.trigger(s);
                        P()
                    }
                    K.droppable("disable")
                }
                K.selectable("disable").removeClass(p);
                k = true
            }).dragstop(function() {
                K.selectable("enable").droppable("enable");
                k = false
                ...
                var r = t.cwd().hash,
                    i;
                _();
                e.each(n.data.added || [], function(e, t) {
                    t && t.phash == r && O(t.hash)
                });
                P()
            }).shortcut({
                pattern: "ctrl+a",
    ...
    e.fn.elfinderdialog = function(t) {
        var n;
        if (typeof t == "string" && (n = this.closest(".ui-dialog")).length) {
            if (t == "open") {
                n.css("display") == "none" && n.fadeIn(120, function() {
                    n.trigger("open")
                })
            } else if (t == "close") {
                n.css("display") != "none" && n.hide().trigger("close")
            } else if (t == "destroy") {
                n.hide().remove()
            } else if (t == "toTop") {
                n.trigger("totop")
        ...
        t = e.extend({}, e.fn.elfinderdialog.defaults, t);
        this.filter(":not(.ui-dialog-content)").each(function() {
            var n = e(this).addClass("ui-dialog-content ui-widget-content"),
                ...
                h = e('<div class="ui-dialog ui-widget ui-widget-content ui-corner-all ui-draggable bounceIn animated std42-dialog  ' + s + " " + t.cssClass + '"/>').hide().append(n).appendTo(r).draggable({
                    ...
                    t.stopPropagation();
                    e(document).mousedown();
                    if (!h.is("." + i)) {
                        r.find("." + s + ":visible").removeClass(i);
                        h.addClass(i).zIndex(p() + 1)
                    }
                }).bind("open", function() {
                    h.trigger("totop");
                    typeof t.open == "function" && e.proxy(t.open, n[0])();
                    if (!h.is("." + o)) {
                        r.find("." + s + ":visible").not("." + o).each(function() {
                            var t = e(this),
                    ...
                    var i = r.find(".elfinder-dialog:visible"),
                        s = p();
                    e(this).data("modal") && f.elfinderoverlay("hide");
                    if (i.length) {
                        i.each(function() {
                            var t = e(this);
                            if (t.zIndex() >= s) {
                    ...
                    if (typeof t.close == "function") {
                        e.proxy(t.close, n[0])()
                    } else if (t.destroyOnClose) {
                        h.hide().remove()
                    }
                }).bind("totop", function() {
                    e(this).mousedown().find(".ui-button:first").focus().end().find(":text:first").focus();
                    e(this).data("modal") && f.elfinderoverlay("show");
                    f.zIndex(e(this).zIndex())
                }).data({
                    modal: t.modal
                }),
                p = function() {
                    var t = r.zIndex() + 10;
                    r.find("." + s + ":visible").each(function() {
                        var n;
                        if (this != h[0]) {
                            n = e(this).zIndex();
                            if (n > t) {
                ...
                d;
            if (!t.position) {
                d = parseInt((r.height() - h.outerHeight()) / 2 - 42);
                t.position = {
                    top: (d > 0 ? d : 0) + "px",
            ...
            h.css(t.position);
            if (t.closeOnEscape) {
                e(document).bind("keyup." + a, function(t) {
                    if (t.keyCode == e.ui.keyCode.ESCAPE && h.is("." + i)) {
                        n.elfinderdialog("close");
                        e(document).unbind("keyup." + a)
                    }
                })
            }
            h.prepend(e('<div class="ui-dialog-titlebar ui-widget-header ui-corner-all ui-helper-clearfix">' + t.title + "</div>").prepend(e('<a href="#" class="ui-dialog-titlebar-close ui-corner-all"><span class="ui-icon ui-icon-closethick">&times;</span></a>').mousedown(function(e) {
                e.preventDefault();
                n.elfinderdialog("close")
            })));
            e.each(t.buttons, function(t, r) {
                var i = e('<button type="button" class="ui-button btn btn-xs ui-widget ui-state-default ui-corner-all ui-button-text-only"><span class="ui-button-text">' + t + "</span></button>").click(e.proxy(r, n[0])).hover(function(t) {
                    ...
                    var n;
                    if (t.keyCode == e.ui.keyCode.ENTER) {
                        e(this).click()
                    } else if (t.keyCode == e.ui.keyCode.TAB) {
                        n = e(this).next(".ui-button");
                        n.length ? n.focus() : e(this).parent().children(".ui-button:first").focus()
                    }
                });
                l.append(i)
            });
            l.children().length && h.append(c);
            if (t.resizable && e.fn.resizable) {
                h.resizable({
                    minWidth: t.minWidth,
            ...
            typeof t.create == "function" && e.proxy(t.create, this)();
            t.autoOpen && n.elfinderdialog("open")
        });
        return this
    };
            ...
            if (e.fn.resizable) {
                a = r.resizable({
                    ...
                    a.css({
                        ...
                        left: u ? "auto" : parseInt(r.scrollLeft() + e),
                        right: u ? parseInt(r.scrollLeft() - e) * -1 : "auto"
                    })
                }).find(".ui-resizable-handle").zIndex(r.zIndex() + 10);
                if (!u) {
                    r.resize(function() {
    ...
    e.fn.elfinderoverlay = function(t) {
        this.filter(":not(.elfinder-overlay)").each(function() {
            t = e.extend({}, t);
            e(this).addClass("ui-widget-overlay elfinder-overlay").hide().mousedown(function(e) {
                e.preventDefault();
                e.stopPropagation()
            }).data({
                cnt: 0,
    ...
    e.fn.elfinderpanel = function(t) {
        return this.each(function() {
            ...
            t.one("load", function(e) {
                ...
                n.css(r, parseInt(i.outerWidth(true)));
                i.bind("resize", function() {
                    n.is(":visible") && n.css(r, parseInt(i.outerWidth(true)))
                })
            })
        })
    };
    ...
    e.fn.elfinderplaces = function(t, n) {
        return this.each(function() {
            var r = [],
                ...
                g = function(n) {
                    ...
                    if (S.children().length) {
                        e.each(S.children(), function() {
                            var t = e(this);
                            if (n.name.localeCompare(t.children("." + s).text()) < 0) {
                                return !i.insertBefore(t)
                            }
                        })
                    }
                    r.push(n.hash);
                    !i.parent().length && S.append(i);
                    E.addClass(o);
                    i.draggable({
                        appendTo: "body",
                        revert: false,
                        helper: function() {
                            var n = e(this);
                            n.children().removeClass("ui-state-hover");
                            return e('<div class="elfinder-place-drag elfinder-' + t.direction + '"/>').append(n.clone()).data("hash", p(n.children(":first").attr("id")))
                        },
                        start: function() {
                            e(this).hide()
                        },
                        stop: function(t, n) {
                            var r = x.offset().top,
                                ...
                                u = t.clientX,
                                a = t.clientY;
                            if (u > i && u < i + s && a > r && a < a + o) {
                                e(this).show()
                            } else {
                                y(n.helper.data("hash"));
                                v()
                            }
                        }
                    })
                ...
                y = function(t) {
                    ...
                    if (n !== -1) {
                        r.splice(n, 1);
                        S.find("#" + d(t)).parent().remove();
                        !S.children().length && E.removeClass(o + " " + u)
                    }
                },
                b = function() {
                    S.empty();
                ...
                E = w.children("." + s).addClass(f).click(function() {
                    if (E.is("." + o)) {
                        x.toggleClass(u);
                        S.slideToggle();
                        t.storage("placesState", x.is("." + u) ? 1 : 0)
                    }
                }),
                ...
                x = e(this).addClass(t.res(i, "tree") + " elfinder-places ui-corner-all").hide().append(w).appendTo(t.getUI("navbar")).delegate("." + s, "hover", function() {
                    ...
                    drop: function(n, i) {
                        ...
                        e.each(i.helper.data("files"), function(n, i) {
                            var o = t.file(i);
                            if (o && o.mime == "directory" && e.inArray(o.hash, r) === -1) {
                                g(o)
                            } else {
                                s = false
                            }
            ...
            t.one("load", function() {
                ...
                x.show().parent().show();
                r = e.map(t.storage("places").split(","), function(e) {
                    return e || null
                });
                if (r.length) {
                    E.prepend(h);
                ...
                t.remove(function(t) {
                    ...
                    e.each(t.data.changed, function(t, n) {
                        if (e.inArray(n.hash, r) !== -1) {
                            y(n.hash);
                            n.mime == "directory" && g(n)
                        }
                    });
                    v()
                }).bind("sync", function() {
    ...
    e.fn.elfindersearchbutton = function(t) {
        return this.each(function() {
            var n = false,
                ...
                o = e('<input type="text" size="42" class="file-search" />').appendTo(r).keypress(function(e) {
                    e.stopPropagation()
                }).keydown(function(e) {
                    e.stopPropagation();
                    e.keyCode == 13 && i();
            ...
            e('<span class="ui-icon ui-icon-search tooltips" title="' + t.title + '"></span>').appendTo(r).click(i);
            e('<span class="ui-icon ui-icon-close icon-close">&times;</span>').appendTo(r).click(s);
            setTimeout(function() {
                r.parent().detach();
                t.fm.getUI("toolbar").prepend(r.show());
                if (t.fm.UA.ltIE7) {
                    var e = r.children(t.fm.direction == "ltr" ? ".ui-icon-close" : ".ui-icon-search");
                    e.css({
                        right: "",
                        left: parseInt(r.width()) - e.outerWidth(true)
                    })
                }
            }, 200);
            t.fm.error(function() {
    ...
    e.fn.elfindersortbutton = function(t) {
        return this.each(function() {
            var n = t.fm,
                ...
                f = a + "-asc",
                l = a + "-desc",
                c = e(this).addClass("ui-state-default elfinder-button tooltips elfinder-menubutton elfiner-button-" + r).attr("title", t.title).append('<span class="elfinder-button-icon elfinder-button-icon-' + r + '"/>').hover(function(e) {
                    !c.is("." + s) && c.toggleClass(o)
                }).click(function(e) {
                    if (!c.is("." + s)) {
                        e.stopPropagation();
                        h.is(":hidden") && t.fm.getUI().click();
                        h.slideToggle(100)
                    }
                }),
                h = e('<div class="ui-widget ui-widget-content elfinder-button-menu fadeIn animated ui-corner-all"/>').hide().appendTo(c).zIndex(12 + c.zIndex()).delegate("." + u, "hover", function() {
                    e(this).toggleClass(o)
                ...
                p = function() {
                    h.children(":not(:last)").removeClass(a + " " + f + " " + l).filter('[rel="' + n.sortType + '"]').addClass(a + " " + (n.sortOrder == "asc" ? f : l));
                    h.children(":last").toggleClass(a, n.sortStickFolders)
                },
                d = function() {
                    h.hide()
                };
            ...
            n.bind("disable select", d).getUI().click(d);
            n.bind("sortchange", p);
            if (h.children().length > 1) {
                t.change(function() {
                    c.toggleClass(s, t.disabled());
                    p()
                }).change()
            } else {
                c.addClass(s)
    ...
    e.fn.elfinderstat = function(t) {
        return this.each(function() {
            ...
            t.getUI("statusbar").prepend(n).append(r).show();
            t.bind("open reload add remove change searchend", function() {
                ...
                if (u.length == 1) {
                    n = u[0].size;
                    r.html(t.escape(u[0].name) + (n > 0 ? ", " + t.formatSize(n) : ""));
                    return
                }
                e.each(u, function(e, t) {
                    s++;
    ...
    e.fn.elfindertoolbar = function(t, n) {
        this.not(".elfinder-toolbar").each(function() {
            ...
            while (o--) {
                if (s[o]) {
                    f = e('<div class="ui-widget-content ui-corner-all elfinder-buttonset"/>');
                    u = s[o].length;
                    while (u--) {
                        if (a = r[s[o][u]]) {
                            l = "elfinder" + a.options.ui;
                            e.fn[l] && f.prepend(e("<div/>")[l](a))
                        }
                    }
                    f.children().length && i.prepend(f);
                    f.children(":gt(0)").before('<span class="ui-widget-content elfinder-toolbar-button-separator"/>')
                }
            }
    ...
    e.fn.elfindertree = function(t, n) {
        ...
        this.not("." + r).each(function() {
            var i = "class",
                ...
                k = function(e) {
                    e.name = t.escape(e.i18 || e.name);
                    return x.replace(/(?:\{([a-z]+)\})/ig, function(t, n) {
                ...
                O = function(n, r) {
                    ...
                    while (i.length) {
                        ...
                        if ((s = t.file(t.navId2Hash(i.children("[id]").attr("id")))) && r.name.toLowerCase().localeCompare(s.name.toLowerCase()) < 0) {
                            return i
                        }
                        i = i.next()
                    }
                ...
                M = function(e) {
                    ...
                    while (i--) {
                        s = e[i];
                        if (H.find("#" + t.navHash2Id(s.hash)).length) {
                            continue
                        }
                        if ((u = A(s.phash)).length) {
                            o = k(s);
                            if (s.phash && (a = O(u, s)).length) {
                                a.before(o)
                            } else {
                                u[f || s.phash ? "append" : "prepend"](o);
                                f = false
                            }
                        } else {
                            r.push(s)
                ...
                _ = function(e) {
                    var r = t.cwd().hash,
                        ...
                        f, h;
                    if (o) {
                        f = H.find("#" + t.navHash2Id(t.root()));
                        f.is("." + c) && f.addClass(l).next("." + u).show();
                        o = false
                    }
                    if (!i.is("." + p)) {
                        H.find("." + a + "." + p).removeClass(p);
                        i.addClass(p)
                    }
                    if (n.syncTree) {
                        if (i.length) {
                            return i.parentsUntil("." + s).filter("." + u).show().prev("." + a).addClass(l)
                        }
                        if (t.newAPI) {
                            h = t.file(r);
                            if (h && h.phash && H.find("#" + t.navHash2Id(h.phash)).length) {
                                M([h]);
                                return _()
                            }
                            t.request({
                ...
                H = e(this).addClass(r).delegate("." + a, "hover", function(n) {
                    var r = e(this),
                        i = n.type == "mouseenter";
                    if (!r.is("." + d + " ,." + m)) {
                        i && !r.is("." + s + ",." + g + ",.elfinder-na,.elfinder-wo") && r.draggable(t.draggable);
                        r.toggleClass(v, i)
                    }
                    ...
                    var r = e(this),
                        ...
                        s = t.file(i);
                    t.trigger("searchend");
                    if (i != t.cwd().hash && !r.is("." + m)) {
                        t.exec("open", s.thash || i)
                    } else if (r.is("." + f)) {
                        r.children("." + h).click()
                    }
            ...
            t.open(function(e) {
                ...
                while (i--) {
                    ...
                    if ((o = H.find("#" + t.navHash2Id(s.hash))).length) {
                        if (s.phash) {
                            ...
                            if (p[0] !== h[0] || d.get(0) !== v.get(0)) {
                                v.length ? v.before(o) : p.append(o)
                            }
                        }
                        m = o.is("." + l);
                        g = o.is("." + c);
                        f = e(k(s));
                        o.replaceWith(f.children("." + a));
                        if (s.dirs && (m || g) && (o = H.find("#" + t.navHash2Id(s.hash))) && o.next("." + u).children().length) {
                            m && o.addClass(l);
                            g && o.addClass(c)
                        }
                    }
                ...
                var n = e.data.removed,
                    ...
                    i, s;
                while (r--) {
                    if ((i = H.find("#" + t.navHash2Id(n[r]))).length) {
                        s = i.closest("." + u);
                        i.parent().detach();
                        if (!s.children().length) {
                            s.hide().prev("." + a).removeClass(f + " " + l + " " + c)
                        }
                    }
                }
                ...
                e.each(s, function(e, n) {
                    ...
                    if (s.length) {
                        s.is("." + g) && s.draggable(i);
                        s.is("." + y) && s.droppable(p);
                        s[r ? "addClass" : "removeClass"](m)
                    }
                })
            })
        });
            ...
            var n = e(this).elfinderbutton(t).unbind("click"),
                ...
                i = e('<input type="file" multiple="true"/>').change(function() {
                    ...
                    if (n.val()) {
                        ...
                        i.clone(true).appendTo(r)
                    }
                });
            r.append(i.clone(true));
            t.change(function() {
    ...
    e.fn.elfinderviewbutton = function(t) {
        return this.each(function() {
            ...
            t.change(function() {
                var e = t.value == "icons";
                r.toggleClass("elfinder-button-icon-view-list", e);
                n.attr("title", t.fm.i18n(e ? "viewlist" : "viewicons"))
            })
        })
    };
    e.fn.elfinderworkzone = function(t) {
        var n = "elfinder-workzone";
        this.not("." + n).each(function() {
            var t = e(this).addClass(n),
                r = t.outerHeight(true) - t.height(),
                i = t.parent();
    ...
    elFinder.prototype.commands.archive = function() {
        ...
        n.bind("open reload", function() {
            t.variants = [];
            e.each(r = n.option("archivers")["create"] || [], function(e, r) {
        ...
        this.exec = function(t, i) {
            var s = this.files(t),
                ...
                u = i || r[0],
                a = n.cwd(),
                f = ["errArchive", "errPerm", "errCreatingTempDir", "errFtpDownloadFile", "errFtpUploadFile", "errFtpMkdir", "errArchiveExec", "errExtractExec", "errRm"],
                l = e.Deferred().fail(function(e) {
                    e && n.error(e)
                }),
                c;
            if (!(this.enabled() && o && r.length && e.inArray(u, r) !== -1)) {
                return l.reject()
            }
            if (!a.write) {
                return l.reject(f)
    ...
    elFinder.prototype.commands.copy = function() {
        ...
        this.exec = function(t) {
            ...
            e.each(this.files(t), function(e, t) {
                if (!(t.read && t.phash)) {
                    return !r.reject(["errCopy", t.name, "errPerm"])
                }
            });
            return r.state() == "rejected" ? r : r.resolve(n.clipboard(this.hashes(t)))
        }
    };
    elFinder.prototype.commands.cut = function() {
        ...
        this.exec = function(t) {
            ...
            e.each(this.files(t), function(e, t) {
                ...
                if (t.locked) {
                    return !r.reject(["errLocked", t.name])
                }
            });
            return r.state() == "rejected" ? r : r.resolve(n.clipboard(this.hashes(t), true))
        }
    };
    elFinder.prototype.commands.download = function() {
        ...
        this.getstate = function() {
            var e = this.fm.selected(),
                t = e.length;
            return !this._disabled && t && (!n.UA.IE || t == 1) && t == r(e).length ? 0 : -1
        };
        this.exec = function(t) {
            var n = this.fm,
                i = n.options.url,
            ...
            if (n.oldAPI) {
                n.error("errCmdNoSupport");
                return o.reject()
            }
            a = e.param(n.options.customData || {});
            if (a) {
                a = "&" + a
            }
            i += i.indexOf("?") === -1 ? "?" : "&";
            for (f = 0; f < s.length; f++) {
                u += '<iframe class="downloader" id="downloader-' + s[f].hash + '" style="display:none" src="' + i + "cmd=file&target=" + s[f].hash + "&download=1" + a + '"/>'
            }
            e(u).appendTo("body").ready(function() {
                setTimeout(function() {
                    e(u).each(function() {
                        e("#" + e(this).attr("id")).remove()
                    })
                }, n.UA.Firefox ? 2e4 + 1e4 * f : 1e3)
            });
            n.trigger("download", {
                files: s
            });
    ...
    elFinder.prototype.commands.duplicate = function() {
        ...
        this.exec = function(t) {
            ...
            e.each(r, function(e, t) {
                if (!t.read || !n.file(t.phash).write) {
                    return !s.reject(["errCopy", t.name, "errPerm"])
                }
            });
            if (s.state() == "rejected") {
                return s
        ...
        var t = this,
            ...
            s = function(r, i, s) {
                var o = e.Deferred(),
                    ...
                    a = function() {
                        u.editor && u.editor.save(u[0], u.editor.instance);
                        o.resolve(u.getContent());
                        u.elfinderdialog("close")
                    },
                    f = function() {
                        o.reject();
                        u.elfinderdialog("close")
                    ...
                    l = {
                        ...
                        buttons: {},
                        close: function() {
                            u.editor && u.editor.close(u[0], u.editor.instance);
                            e(this).elfinderdialog("destroy")
                        },
                        open: function() {
                            n.disable();
                            u.focus();
                            u[0].setSelectionRange && u[0].setSelectionRange(0, 0);
                            u.editor && u.editor.load(u[0])
                        }
                    };
                ...
                e.each(t.options.editors || [], function(t, n) {
                    if (e.inArray(i.mime, n.mimes || []) !== -1 && typeof n.load == "function" && typeof n.save == "function") {
                        u.editor = {
                            load: n.load,
                            save: n.save,
                    ...
                    u.keydown(function(e) {
                        ...
                        if (t == 9) {
                            ...
                            if (this.setSelectionRange) {
                                ...
                                this.value = n.substr(0, r) + "	" + n.substr(this.selectionEnd);
                                r += 1;
                ...
                l.buttons[n.i18n("Save")] = a;
                l.buttons[n.i18n("Cancel")] = f;
                n.dialog(u, l).attr("id", r);
                return o.promise()
            },
            o = function(t) {
                var r = t.hash,
                    ...
                    c;
                if (l.length) {
                    l.elfinderdialog("toTop");
                    return o.resolve()
                }
                if (!t.read || !t.write) {
                    c = ["errOpen", t.name, "errPerm"];
                    n.error(c);
                    return o.reject(c)
                }
                n.request({
                    ...
                    s(f, t, e.content).done(function(e) {
                        n.request({
                            ...
                            e.changed && e.changed.length && n.change(e);
                            o.resolve(e)
                        })
                    })
                }).fail(function(e) {
    ...
    elFinder.prototype.commands.extract = function() {
        ...
        this.exec = function(t) {
            ...
            var l = false;
            var c = false;
            var h = e.map(n.files(t), function(e) {
                return e.name
            });
            var p = {};
            ...
            var v = function(t) {
                if (!(t.read && n.file(t.phash).write)) {
                    a = ["errExtract", t.name, "errPerm"];
                    n.error(a);
                    s.reject(a)
                } else if (e.inArray(t.mime, r) === -1) {
                    a = ["errExtract", t.name, "errNoArchive"];
                    n.error(a);
                    s.reject(a)
                } else {
                    n.request({
            ...
            var m = function(t, r) {
                var i = t[r];
                var a = i.name.replace(/\.((tar\.(gz|bz|bz2|z|lzo))|cpio\.gz|ps\.gz|xcf\.(gz|bz2)|[a-z0-9]{1,4})$/ig, "");
                var g = e.inArray(a, h) >= 0;
                if (g && p[a].mime != "directory") {
                    n.confirm({
                        title: n.i18n("ntfextract"),
                        text: n.i18n(["errExists", a, "confirmRepl"]),
                        accept: {
                            label: "btnYes",
                            callback: function(e) {
                                f = e ? "overwrite_all" : "overwrite";
                                d(f);
                                if (!l && !c) {
                                    if ("overwrite" == f) {
                                        v(i)
    ...
    elFinder.prototype.commands.getfile = function() {
        var t = this,
            ...
            r = function(n) {
                ...
                return r.multiple || n.length == 1 ? n : []
            };
        this.alwaysEnabled = true;
        this.callback = n.options.getFileCallback;
        ...
        this.exec = function(n) {
            var r = this.fm,
                ...
                f = e.Deferred().done(function(e) {
                    ...
                    t.callback(e, r);
                    if (i.oncomplete == "close") {
                        r.hide()
                    } else if (i.oncomplete == "destroy") {
                        r.destroy()
                    }
                }),
                l = function(t) {
            ...
            for (h = 0; h < o; h++) {
                ...
                if (!p.width && !p.height) {
                    if (p.dim) {
                        ...
                        p.width = d[0];
                        p.height = d[1]
                    } else if (p.mime.indexOf("image") !== -1) {
                        c.push(r.request({
                            data: {
                                cmd: "dim",
                                target: p.hash
                            ...
                            if (e.dim) {
                                var t = e.dim.split("x");
                                var n = r.file(this.hash);
                                n.width = this.width = t[0];
                                n.height = this.height = t[1]
                            }
                        }.bind(p)))
                    }
                }
            ...
            if (c.length) {
                e.when.apply(null, c).always(function() {
                    f.resolve(l(s))
                });
                return f
            }
            return f.resolve(l(s))
        }
    };
    elFinder.prototype.commands.help = function() {
        var t = this.fm,
            ...
            s = '<div class="elfinder-help-team"><div>{author}</div>{work}</div>',
            o = /\{url\}/,
            u = /\{link\}/,
            a = /\{author\}/,
            f = /\{work\}/,
            ...
            d = '<li class="ui-state-default ui-corner-top"><a href="#{id}">{title}</a></li>',
            v = ['<div class="ui-tabs ui-widget ui-widget-content ui-corner-all elfinder-help">', '<ul class="ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all">'],
            ...
            y = function() {
                v.push('<div id="about" class="ui-tabs-panel ui-widget-content ui-corner-bottom"><div class="elfinder-help-logo"/>');
                v.push("<h3>elFinder</h3>");
                v.push('<div class="' + c + '">' + t.i18n("webfm") + "</div>");
                v.push('<div class="' + h + '">' + t.i18n("ver") + ": " + t.version + ", " + t.i18n("protocolver") + ': <span id="apiver"></span></div>');
                v.push('<div class="' + h + '">jQuery/jQuery UI: ' + e().jquery + "/" + e.ui.version + "</div>");
                v.push(g);
                v.push(i[l](o, "http://elfinder.org/")[l](u, t.i18n("homepage")));
                v.push(i[l](o, "https://github.com/Studio-42/elFinder/wiki")[l](u, t.i18n("docs")));
                v.push(i[l](o, "https://github.com/Studio-42/elFinder")[l](u, t.i18n("github")));
                v.push(i[l](o, "http://twitter.com/elrte_elfinder")[l](u, t.i18n("twitter")));
                v.push(g);
                v.push('<div class="' + c + '">' + t.i18n("team") + "</div>");
                v.push(s[l](a, 'Dmitry "dio" Levashov &lt;dio@std42.ru&gt;')[l](f, t.i18n("chiefdev")));
                v.push(s[l](a, "Troex Nevelin &lt;troex@fury.scancode.ru&gt;")[l](f, t.i18n("maintainer")));
                v.push(s[l](a, "Alexey Sukhotin &lt;strogg@yandex.ru&gt;")[l](f, t.i18n("contributor")));
                v.push(s[l](a, "Naoki Sawada &lt;hypweb@gmail.com&gt;")[l](f, t.i18n("contributor")));
                t.i18[t.lang].translator && v.push(s[l](a, t.i18[t.lang].translator)[l](f, t.i18n("translator") + " (" + t.i18[t.lang].language + ")"));
                v.push(g);
                v.push('<div class="' + p + '">' + t.i18n("icons") + ': Pixelmixer, <a href="http://p.yusukekamiyamane.com" target="_blank">Fugue</a></div>');
                v.push(g);
                v.push('<div class="' + p + '">Licence: BSD Licence</div>');
                v.push('<div class="' + p + '">Copyright © 2009-2011, Studio 42</div>');
                v.push('<div class="' + p + '">„ …' + t.i18n("dontforget") + " ”</div>");
                v.push("</div>")
            },
            b = function() {
                var n = t.shortcuts();
                v.push('<div id="shortcuts" class="ui-tabs-panel ui-widget-content ui-corner-bottom">');
                if (n.length) {
                    v.push('<div class="ui-widget-content elfinder-help-shortcuts">');
                    e.each(n, function(e, t) {
                        v.push(m.replace(/\{pattern\}/, t[0]).replace(/\{descrip\}/, t[1]))
                    });
                    v.push("</div>")
                } else {
                    v.push('<div class="elfinder-help-disabled">' + t.i18n("shortcutsof") + "</div>")
                }
                v.push("</div>")
            },
            w = function() {
                v.push('<div id="help" class="ui-tabs-panel ui-widget-content ui-corner-bottom">');
                v.push('<a href="http://elfinder.org/forum/" target="_blank" class="elfinder-dont-panic"><span>DON\'T PANIC</span></a>');
                v.push("</div>")
            },
            E;
        this.alwaysEnabled = true;
        ...
        setTimeout(function() {
            ...
            e.each(r, function(e, n) {
                v.push(d[l](/\{id\}/, n)[l](/\{title\}/, t.i18n(n)))
            });
            v.push("</ul>");
            e.inArray("about", r) !== -1 && y();
            e.inArray("shortcuts", r) !== -1 && b();
            e.inArray("help", r) !== -1 && w();
            v.push("</div>");
            E = e(v.join(""));
            t.one("load", function() {
                E.find("#apiver").text(t.api)
            });
            E.find(".ui-tabs-nav li").hover(function() {
                e(this).toggleClass("ui-state-hover")
            }).children().click(function(t) {
                var n = e(this);
                t.preventDefault();
                t.stopPropagation();
                if (!n.is(".ui-tabs-selected")) {
                    n.parent().addClass("ui-tabs-selected ui-state-active").siblings().removeClass("ui-tabs-selected").removeClass("ui-state-active");
                    E.find(".ui-tabs-panel").hide().filter(n.attr("href")).show()
                }
            }).filter(":first").click()
        }, 200);
        this.getstate = function() {
    ...
    elFinder.prototype.commands.info = function() {
        ...
        this.exec = function(t) {
            ...
            var s = this,
                ...
                g = o.namespace + "-info-" + e.map(n, function(e) {
                        return e.hash
                    }).join("-"),
                y = o.getUI().find("#" + g),
                b, w, E, S, x;
            ...
            if (y.length) {
                y.elfinderdialog("toTop");
                return e.Deferred().resolve()
            }
            if (f == 1) {
                E = n[0];
                c = c.replace("{class}", o.mime2class(E.mime));
                S = u.itemTitle.replace("{name}", o.escape(E.i18 || E.name)).replace("{kind}", o.mime2kind(E));
                if (E.tmb) {
                    w = o.option("tmbUrl") + E.tmb
                }
                if (!E.read) {
                    b = i.unknown
                } else if (E.mime != "directory" || E.alias) {
                    b = o.formatSize(E.size)
                } else {
                    b = u.spinner.replace("{text}", i.calc);
                    v.push(E.hash)
                }
                l.push(a.replace(h, i.size).replace(p, b));
                E.alias && l.push(a.replace(h, i.aliasfor).replace(p, E.alias));
                l.push(a.replace(h, i.path).replace(p, o.escape(o.path(E.hash, true))));
                E.read && l.push(a.replace(h, i.link).replace(p, '<a href="' + o.url(E.hash) + '" target="_blank">' + E.name + "</a>"));
                if (E.dim) {
                    l.push(a.replace(h, i.dim).replace(p, E.dim))
                } else if (E.mime.indexOf("image") !== -1) {
                    if (E.width && E.height) {
                        l.push(a.replace(h, i.dim).replace(p, E.width + "x" + E.height))
                    } else {
                        l.push(a.replace(h, i.dim).replace(p, u.spinner.replace("{text}", i.calc)));
                        o.request({
                            data: {
                                cmd: "dim",
                                target: E.hash
                ...
                l.push(a.replace(h, i.modify).replace(p, o.formatDate(E)));
                l.push(a.replace(h, i.perms).replace(p, o.formatPermissions(E)));
                l.push(a.replace(h, i.locked).replace(p, E.locked ? i.yes : i.no))
            } else {
                c = c.replace("{class}", "elfinder-cwd-icon-group");
                S = u.groupTitle.replace("{items}", i.items).replace("{num}", f);
                x = e.map(n, function(e) {
                ...
                if (!x) {
                    ...
                    l.push(a.replace(h, i.kind).replace(p, i.files));
                    l.push(a.replace(h, i.size).replace(p, o.formatSize(b)))
                } else {
                    l.push(a.replace(h, i.kind).replace(p, x == f ? i.folders : i.folders + " " + x + ", " + i.files + " " + (f - x)));
                    l.push(a.replace(h, i.size).replace(p, u.spinner.replace("{text}", i.calc)));
                    v = e.map(n, function(e) {
                        return e.hash
                    })
                }
            }
            c = c.replace("{title}", S).replace("{content}", l.join(""));
            y = o.dialog(c, d);
            y.attr("id", g);
            if (w) {
                e("<img/>").load(function() {
            ...
            if (v.length) {
                o.request({
                    ...
                    m(t >= 0 ? o.formatSize(t) : i.unknown)
                })
            }
        }
    };
        ...
        this.exec = function() {
            var n = t.fm,
                ...
                i = function() {
                    ...
                    e.each(t.drivers, function(e, t) {
                        i.protocol.append('<option value="' + t + '">' + n.i18n(t) + "</option>")
                    });
                    e.each(i, function(t, r) {
                        t != "protocol" && r.addClass("ui-corner-all");
                        o.append(e("<tr/>").append(e("<td>" + n.i18n(t) + "</td>")).append(e("<td/>").append(r)))
                    });
    ...
    elFinder.prototype.commands.open = function() {
        ...
        this.exec = function(t) {
            ...
            if (s == 1 && (o = i[0]) && o.mime == "directory") {
                return o && !o.read ? r.reject(["errOpen", o.name, "errPerm"]) : n.request({
                    data: {
                        cmd: "open",
            ...
            while (s--) {
                o = i[s];
                if (!o.read) {
                    return r.reject(["errOpen", o.name, "errPerm"])
                }
                if (!(u = n.url(o.hash))) {
                    u = n.options.url;
                    u = u + (u.indexOf("?") === -1 ? "?" : "&") + (n.oldAPI ? "cmd=open&current=" + o.phash : "cmd=file") + "&target=" + o.hash
                }
                if (o.dim) {
                    a = o.dim.split("x");
                    f = "width=" + (parseInt(a[0]) + 20) + ",height=" + (parseInt(a[1]) + 20)
                } else {
                    f = "width=" + parseInt(2 * e(window).width() / 3) + ",height=" + parseInt(2 * e(window).height() / 3)
                }
                if (!window.open(u, "_blank", f + ",top=50,left=50,scrollbars=yes,resizable=yes")) {
                    return r.reject("errPopup")
                }
            }
            return r.resolve(t)
        }
        ...
        this.exec = function(t) {
            var n = this,
                ...
                h = function(i) {
                    var s = e.Deferred(),
                        ...
                        a = function(t, n) {
                            var r = [],
                                i = t.length;
                            while (i--) {
                                e.inArray(t[i].name, n) !== -1 && r.unshift(i)
                            }
                            return r
                        },
                        f = function(e) {
                    ...
                    if (n._disabled || !i.length) {
                        return s.resolve()
                    }
                    if (r.oldAPI) {
                        c(i)
                    } else {
                        if (!r.option("copyOverwrite")) {
                            c(i)
                        } else {
                            t.hash == r.cwd().hash ? l(e.map(r.files(), function(e) {
                ...
                p, d;
            if (!s || !t || t.mime != "directory") {
                return l.reject()
            }
            if (!t.write) {
                return l.reject([u, i[0].name, "errPerm"])
            }
            p = r.parents(t.hash);
            e.each(i, function(n, s) {
                ...
                if (o && s.locked) {
                    return !l.reject(["errLocked", s.name])
                }
                if (e.inArray(s.hash, p) !== -1) {
                    return !l.reject(["errCopyInItself", s.name])
                }
                d = r.parents(s.hash);
                if (e.inArray(t.hash, d) !== -1) {
                    if (e.map(d, function(e) {
                            var n = r.file(e);
                            return n.phash == t.hash && n.name == s.name ? n : null
                        }).length) {
                        return !l.reject(["errReplByChild", s.name])
                    }
                }
                if (s.phash == t.hash) {
                    f.push(s.hash)
            ...
            return e.when(c(f), h(a)).always(function() {
                o && r.clipboard([])
            })
        }
    };
    elFinder.prototype.commands.quicklook = function() {
        var t = this,
            ...
            w = e('<div class="' + u + " " + u + '-fullscreen"/>').mousedown(function(r) {
                ...
                r.stopPropagation();
                if (s) {
                    i.css(i.data("position")).unbind("mousemove");
                    f.unbind(o).trigger(t.resize).unbind(t.resize);
                    E.unbind("mouseenter").unbind("mousemove")
                } else {
                    i.data("position", {
                        left: i.css("left"),
                        top: i.css("top"),
                    ...
                    }).trigger(o).trigger(t.resize);
                    i.bind("mousemove", function(e) {
                        E.stop(true, true).show().delay(3e3).fadeOut("slow")
                    }).mousemove();
                ...
                E.attr("style", "").draggable(s ? "destroy" : {});
                i.toggleClass(a);
                e(this).toggleClass(u + "-fullscreen-off");
                e.fn.resizable && v.add(i).resizable(s ? "enable" : "disable").removeClass("ui-state-disabled")
            }),
        ...
        this.resize = "resize." + n.namespace;
        this.info = e('<div class="elfinder-quicklook-info-wrapper"/>').append(y).append(b);
        this.preview = e('<div class="elfinder-quicklook-preview ui-helper-clearfix"/>').bind("change", function(e) {
            t.info.attr("style", "").hide();
            y.removeAttr("class").attr("style", "");
            b.html("")
            ...
            var r = t.fm,
                ...
                u;
            if (s) {
                !s.read && n.stopImmediatePropagation();
                t.window.data("hash", s.hash);
                t.preview.unbind("changesize").trigger("change").children().remove();
                g.html(r.escape(s.name));
                b.html(o.replace(/\{value\}/, s.name) + o.replace(/\{value\}/, r.mime2kind(s)) + (s.mime == "directory" ? "" : o.replace(/\{value\}/, r.formatSize(s.size))) + o.replace(/\{value\}/, r.i18n("modify") + ": " + r.formatDate(s)));
                y.addClass("elfinder-cwd-icon ui-corner-all " + r.mime2class(s.mime));
                if (s.tmb) {
                    e("<img/>").hide().appendTo(t.preview).load(function() {
                        y.css("background", 'url("' + u + '") center center no-repeat');
                        e(this).remove()
                    }).attr("src", u = r.tmb(s.hash))
                }
                t.info.delay(100).fadeIn(10)
            } else {
                n.stopImmediatePropagation()
            }
        });
        this.window = e('<div class="ui-helper-reset ui-widget elfinder-quicklook" style="position:absolute"/>').click(function(e) {
            ...
            var n = t.window,
                r = t.value,
                u;
            if (t.closed() && r && (u = m.find("#" + r.hash)).length) {
                E.attr("style", "");
                o = i;
                u.trigger("scrolltoview");
                n.css(l(u)).show().animate(c(), 550, function() {
                    o = s;
                    t.update(1, t.value)
                })
            }
            ...
            if (t.opened()) {
                o = i;
                n.is("." + a) && w.mousedown();
                f.length ? n.animate(l(f), 500, c) : c()
            }
        });
        this.alwaysEnabled = true;
        this.value = null;
        ...
        this.init = function() {
            var r = this.options,
                ...
                s = this.preview,
                o, u;
            p = r.width > 0 ? parseInt(r.width) : 450;
            d = r.height > 0 ? parseInt(r.height) : 300;
            n.one("load", function() {
                v = n.getUI();
                m = n.getUI("cwd");
                i.appendTo("body").zIndex(100 + v.zIndex());
                ...
                t.change(function() {
                    if (t.opened()) {
                        t.value ? s.trigger(e.Event("update", {
                            file: t.value
                        })) : i.trigger("close")
                    }
                });
    ...
    elFinder.prototype.commands.quicklook.plugins = [function(t) {
        ...
        e.each(navigator.mimeTypes, function(t, r) {
            var i = r.type;
            if (i.indexOf("image/") === 0 && e.inArray(i, n)) {
                n.push(i)
            }
        });
        r.bind("update", function(i) {
            var s = i.file,
                o;
            if (e.inArray(s.mime, n) !== -1) {
                i.stopImmediatePropagation();
                o = e("<img/>").hide().appendTo(r).load(function() {
                    setTimeout(function() {
                        ...
                        r.bind("changesize", function() {
                            ...
                            o.width(i).height(s).css("margin-top", s < n ? Math.floor((n - s) / 2) : 0)
                        }).trigger("changesize");
                        t.hideinfo();
                        o.fadeIn(100)
                    }, 1)
        ...
        r.bind("update", function(s) {
            var o = s.file,
                u;
            if (e.inArray(o.mime, n) !== -1) {
                s.stopImmediatePropagation();
                r.one("change", function() {
                    u.state() == "pending" && u.reject()
                });
                u = i.request({
                    data: {
                        cmd: "get",
                    ...
                    t.hideinfo();
                    doc = e('<iframe class="elfinder-quicklook-preview-html"/>').appendTo(r)[0].contentWindow.document;
                    doc.open();
                    doc.write(n.content);
                    doc.close()
                })
        ...
        i.bind("update", function(s) {
            var o = s.file,
                u = o.mime,
                a;
            if (u.indexOf("text/") === 0 || e.inArray(u, r) !== -1) {
                s.stopImmediatePropagation();
                i.one("change", function() {
                    a.state() == "pending" && a.reject()
                });
                a = n.request({
                    data: {
                        cmd: "get",
                    ...
                    t.hideinfo();
                    e('<div class="elfinder-quicklook-preview-text-wrapper"><pre class="elfinder-quicklook-preview-text">' + n.escape(r.content) + "</pre></div>").appendTo(i)
                })
            }
        })
    }, function(t) {
        var n = t.fm,
            ...
            i = t.preview,
            s = false;
        if (n.UA.Safari && n.OS == "mac" || n.UA.IE) {
            s = true
        } else {
        ...
        s && i.bind("update", function(s) {
            ...
            if (o.mime == r) {
                s.stopImmediatePropagation();
                t.hideinfo();
                i.append(u = e('<embed class="elfinder-quicklook-preview-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" src="' + n.url(o.hash) + '" quality="high" type="application/x-shockwave-flash" />'))
            }
        })
    }, function(t) {
        var n = t.preview,
        ...
        n.bind("update", function(o) {
            var u = o.file,
                a = i[u.mime];
            if (t.support.audio[a]) {
                o.stopImmediatePropagation();
                s = e('<audio class="elfinder-quicklook-preview-audio" controls preload="auto" autobuffer><source src="' + t.fm.url(u.hash) + '" /></audio>').appendTo(n);
                r && s[0].play()
            }
        }).bind("change", function() {
            if (s && s.parent().length) {
                s[0].pause();
                s.remove();
                s = null
            }
        ...
        n.bind("update", function(o) {
            var u = o.file,
                a = i[u.mime];
            if (t.support.video[a]) {
                o.stopImmediatePropagation();
                t.hideinfo();
                s = e('<video class="elfinder-quicklook-preview-video" controls preload="auto" autobuffer><source src="' + t.fm.url(u.hash) + '" /></video>').appendTo(n);
                r && s[0].play()
            }
        }).bind("change", function() {
            if (s && s.parent().length) {
        ...
        n.bind("update", function(s) {
            var o = s.file,
                u = o.mime,
                a;
            if (e.inArray(o.mime, r) !== -1) {
                s.stopImmediatePropagation();
                (a = u.indexOf("video/") === 0) && t.hideinfo();
                i = e('<embed src="' + t.fm.url(o.hash) + '" type="' + u + '" class="elfinder-quicklook-preview-' + (a ? "video" : "audio") + '"/>').appendTo(n)
            }
        }).bind("change", function() {
            if (i && i.parent().length) {
                i.remove();
                i = null
            }
        })
    ...
    elFinder.prototype.commands.rename = function() {
        ...
        this.exec = function() {
            var t = this.fm,
                ...
                a = e('<input type="text"/>').keydown(function(t) {
                    ...
                    if (r.length) {
                        ...
                        if (!n) {
                            return u.reject("errInvName")
                        }
                        if (t.fileByName(n, s.phash)) {
                            return u.reject(["errExists", n])
                        }
                        r.html(t.escape(n));
                        t.lockfiles({
                            files: [s.hash]
            ...
            if (!s || i > 1 || !f.length) {
                return u.reject("errCmdParams", this.title)
            }
            if (s.locked) {
                return u.reject(["errLocked", s.name])
            }
            t.one("select", function() {
                a.parent().length && s && e.inArray(s.hash, t.selected()) === -1 && a.blur()
            });
            a.select().focus();
            a[0].setSelectionRange && a[0].setSelectionRange(0, l.length);
            return u
        }
    };
            ...
            var n = this.fm,
                ...
                s = function(t, r) {
                    var s = e('<div class="elfinder-dialog-resize"/>'),
                        ...
                        T = e('<div class="elfinder-resize-type"/>').append('<input type="radio" name="type" id="' + r + '-resize" value="resize" checked="checked" /><label for="' + r + '-resize">' + n.i18n("resize") + "</label>").append('<input type="radio" name="type" id="' + r + '-crop" value="crop" /><label for="' + r + '-crop">' + n.i18n("crop") + "</label>").append('<input type="radio" name="type" id="' + r + '-rotate" value="rotate" /><label for="' + r + '-rotate">' + n.i18n("rotate") + "</label>"),
                        N = e("input", T).attr("disabled", "disabled").change(function() {
                        ...
                        k = e(o).change(function() {
                            var e = parseInt(k.val()),
                                t = parseInt(I ? Math.round(e / H) : L.val());
                            if (e > 0 && t > 0) {
                                Y.updateView(e, t);
                                L.val(t)
                            }
                        ...
                        L = e(o).change(function() {
                            var e = parseInt(L.val()),
                                t = parseInt(I ? Math.round(e * H) : k.val());
                            if (t > 0 && e > 0) {
                                Y.updateView(t, e);
                                k.val(t)
                            }
                        }),
                        A = e(o).change(function() {
                            Z.updateView()
                        }),
                        O = e(o).change(function() {
                            Z.updateView()
                        }),
                        M = e(o).change(function() {
                            Z.updateView()
                        }),
                        _ = e(o).change(function() {
                            Z.updateView()
                        }),
                        ...
                        P = e('<div class="elfinder-resize-rotate-slider"/>').slider({
                            ...
                            animate: true,
                            change: function(e, t) {
                                if (t.value != P.slider("value")) {
                                    et.update(t.value)
                                }
                            },
                            slide: function(e, t) {
                                et.update(t.value, false)
                            }
                        }),
                        H = 1,
                        B = 1,
                        ...
                        X = e("<img/>").load(function() {
                            ...
                            z = F * t;
                            N.button("enable");
                            f.find("input,select").removeAttr("disabled").filter(":text").keydown(function(t) {
                                var r = t.keyCode,
                                    i;
                                t.stopPropagation();
                                if (r >= 37 && r <= 40 || r == e.ui.keyCode.BACKSPACE || r == e.ui.keyCode.DELETE || r == 65 && (t.ctrlKey || t.metaKey) || r == 27) {
                                    return
                                }
                                if (r == 9) {
                                    i = e(this).parent()[t.shiftKey ? "prev" : "next"](".elfinder-resize-row").children(":text");
                                    if (i.length) {
                                        i.focus()
                                    } else {
                                        e(this).parent().parent().find(":text:" + (t.shiftKey ? "last" : "first")).focus()
                                    }
                                }
                                if (r == 13) {
                                    n.confirm({
                        ...
                        Y = {
                            update: function() {
                                k.val(Math.round(X.width() / B));
                                L.val(Math.round(X.height() / B))
                            },
                            updateView: function(e, t) {
                                if (e > q || t > R) {
                                    if (e / q > t / R) {
                                        B = q / e;
                                        X.width(q).height(Math.ceil(t * B))
                                    } else {
                                        B = R / t;
                                        X.height(R).width(Math.ceil(e * B))
                                    }
                                } else {
                                    X.width(e).height(t)
                                }
                                B = X.width() / e;
                                S.text("1 : " + (1 / B).toFixed(2));
                                Y.updateHandle()
                            },
                        ...
                        Z = {
                            update: function() {
                                M.val(Math.round((p.data("w") || p.width()) / B));
                                _.val(Math.round((p.data("h") || p.height()) / B));
                                A.val(Math.round(((p.data("x") || p.offset().left) - J.offset().left) / B));
                                O.val(Math.round(((p.data("y") || p.offset().top) - J.offset().top) / B))
                            },
                            updateView: function() {
                                var e = parseInt(A.val()) * B + J.offset().left;
                                var t = parseInt(O.val()) * B + J.offset().top;
                                var n = M.val() * B;
                                var r = _.val() * B;
                                p.data({
                                    x: e,
                                ...
                                p.width(Math.round(n));
                                p.height(Math.round(r));
                                K.width(p.width());
                                K.height(p.height());
                                p.offset({
                                    left: Math.round(e),
                        ...
                        et = {
                            ...
                            execute: function(e) {
                                ...
                                var s = i - et.mouseStartAngle + et.imageStartAngle;
                                s = Math.round(parseFloat(s) * 180 / Math.PI);
                                if (e.shiftKey) {
                                    s = Math.round((s + 6) / 15) * 15
                                }
                                Q.rotate(s);
                                s = s % 360;
                                if (s < 0) {
                            ...
                            start: function(t) {
                                et.imageBeingRotated = true;
                                var n = et.getCenter(Q);
                                var r = t.pageX - n[0];
                                var i = t.pageY - n[1];
                                et.mouseStartAngle = Math.atan2(i, r);
                                et.imageStartAngle = parseFloat(Q.rotate()) * Math.PI / 180;
                                e(document).mousemove(et.execute);
                                return false
                            },
                            stop: function(t) {
                                if (!et.imageBeingRotated) return;
                                e(document).unbind("mousemove", et.execute);
                                setTimeout(function() {
                                    et.imageBeingRotated = false
                                }, 10);
                                return false
                            },
                            getCenter: function(e) {
                                ...
                                Q.rotate(0);
                                var n = Q.offset();
                                var r = n.left + Q.width() / 2;
                                var i = n.top + Q.height() / 2;
                                Q.rotate(t);
                                return Array(r, i)
                            }
                        },
                        tt = function(t) {
                            if (e.fn.resizable) {
                                if (t) {
                                    h.filter(":ui-resizable").resizable("destroy");
                                    h.hide()
                                } else {
                                    h.show();
                                    h.resizable({
                        ...
                        nt = function(t) {
                            if (e.fn.draggable && e.fn.resizable) {
                                if (t) {
                                    p.filter(":ui-resizable").resizable("destroy");
                                    p.filter(":ui-draggable").draggable("destroy");
                                    V.hide()
                                } else {
                                    J.width(X.width()).height(X.height());
                                    K.width(X.width()).height(X.height());
                                    p.width(J.width()).height(J.height()).offset(J.offset()).resizable({
                                        containment: V,
                                    ...
                                    V.show().width(X.width()).height(X.height());
                                    Z.update()
                                }
                            }
                        },
                        rt = function(t) {
                            if (e.fn.draggable && e.fn.resizable) {
                                if (t) {
                                    ...
                                    Q.show().width(U).height(z).css("margin-top", (R - z) / 2 + "px").css("margin-left", (q - U) / 2 + "px")
                                }
                            }
                        },
                        it = function() {
                            var r, o, u, a, f;
                            var l = e("input:checked", T).val();
                            if (l == "resize") {
                                r = parseInt(k.val()) || 0;
                                o = parseInt(L.val()) || 0
                            } else if (l == "crop") {
                                ...
                                f = parseInt(D.val()) || 0;
                                if (f < 0 || f > 360) {
                                    return n.error("Invalid rotate degree")
                                }
                                if (f == 0 || f == 360) {
                                    return n.error("Image dose not rotated")
                                }
                            }
                            if (l != "rotate") {
                                if (r <= 0 || o <= 0) {
                                    return n.error("Invalid image size")
                                }
                                if (r == j && o == F) {
                                    return n.error("Image size not changed")
                                }
                            }
                        ...
                        st = {},
                        ot = "elfinder-resize-handle-hline",
                        ut = "elfinder-resize-handle-vline",
                        at = "elfinder-resize-handle-point",
                        ft = n.url(t.hash);
                    Q.mousedown(et.start);
                    e(document).mouseup(et.stop);
                    d.append(e(u).append(e(a).text(n.i18n("width"))).append(k).append(x)).append(e(u).append(e(a).text(n.i18n("height"))).append(L)).append(e(u).append(e("<label/>").text(n.i18n("aspectRatio")).prepend(C))).append(e(u).append(n.i18n("scale") + " ").append(S));
                    v.append(e(u).append(e(a).text("X")).append(A)).append(e(u).append(e(a).text("Y")).append(O)).append(e(u).append(e(a).text(n.i18n("width"))).append(M)).append(e(u).append(e(a).text(n.i18n("height"))).append(_));
                    b.append(e(u).append(e(a).text(n.i18n("rotate"))).append(e('<div style="float:left; width: 130px;">').append(e('<div style="float:left;">').append(D).append(e("<span/>").text(n.i18n("degree")))).append(e(m).append(w).append(e(y)).append(E))).append(P));
                    s.append(T);
                    f.append(e(u)).append(d).append(v.hide()).append(b.hide()).find("input,select").attr("disabled", "disabled");
                    h.append('<div class="' + ot + " " + ot + '-top"/>').append('<div class="' + ot + " " + ot + '-bottom"/>').append('<div class="' + ut + " " + ut + '-left"/>').append('<div class="' + ut + " " + ut + '-right"/>').append('<div class="' + at + " " + at + '-e"/>').append('<div class="' + at + " " + at + '-se"/>').append('<div class="' + at + " " + at + '-s"/>');
                    l.append(c).append(h.hide()).append(X.hide());
                    p.css("position", "absolute").append('<div class="' + ot + " " + ot + '-top"/>').append('<div class="' + ot + " " + ot + '-bottom"/>').append('<div class="' + ut + " " + ut + '-left"/>').append('<div class="' + ut + " " + ut + '-right"/>').append('<div class="' + at + " " + at + '-n"/>').append('<div class="' + at + " " + at + '-e"/>').append('<div class="' + at + " " + at + '-s"/>').append('<div class="' + at + " " + at + '-w"/>').append('<div class="' + at + " " + at + '-ne"/>').append('<div class="' + at + " " + at + '-se"/>').append('<div class="' + at + " " + at + '-sw"/>').append('<div class="' + at + " " + at + '-nw"/>');
                    l.append(V.css("position", "absolute").hide().append(J).append(p.append(K)));
                    l.append(Q.hide());
                    l.css("overflow", "hidden");
                    s.append(l).append(f);
                    st[n.i18n("btnApply")] = it;
                    st[n.i18n("btnCancel")] = function() {
                        s.elfinderdialog("close")
                    };
                    n.dialog(s, {
                        title: t.name,
                    ...
                    if (n.UA.ltIE8) {
                        e(".elfinder-dialog").css("filter", "")
                    }
                    x.css("left", k.position().left + k.width() + 12);
                    K.css({
                        opacity: .2,
                        "background-color": "#fff",
                        position: "absolute"
                    }), p.css("cursor", "move");
                    p.find(".elfinder-resize-handle-point").css({
                        "background-color": "#fff",
                        opacity: .5,
                        "border-color": "#000"
                    });
                    ...
                    T.buttonset();
                    q = l.width() - (h.outerWidth() - h.width());
                    R = l.height() - (h.outerHeight() - h.height());
                    X.attr("src", ft + (ft.indexOf("?") === -1 ? "?" : "&") + "_=" + Math.random());
                    J.attr("src", X.attr("src"));
                    Q.attr("src", X.attr("src"))
                },
                o, u;
            if (!r.length || r[0].mime.indexOf("image/") === -1) {
                return i.reject()
            }
            o = "resize-" + n.namespace + "-" + r[0].hash;
            u = n.getUI().find("#" + o);
            if (u.length) {
                u.elfinderdialog("toTop");
                return i.resolve()
            }
            s(r[0], o);
            return i
    ...
    (function(e) {
        var t = function(e, t) {
            var n = 0;
            for (n in t) {
                if (typeof e[t[n]] != "undefined") return t[n]
            }
            e[t[n]] = "";
            return t[n]
        };
        ...
        e.fn.rotate = function(e) {
            if (typeof e == "undefined") {
                if ( !! window.opera) {
                    ...
                    return t && t[1] ? Math.round(parseFloat(t[1]) * 180 / Math.PI) : 0
                } else {
                    var t = this.css("transform").match(/rotate\((.*?)\)/);
        ...
        e.fx.step.rotate = function(t) {
            if (t.state == 0) {
                t.start = e(t.elem).rotate();
                t.now = t.start
            }
            e(t.elem).rotate(t.now)
        };
        if (typeof window.addEventListener == "undefined" && typeof document.getElementsByClassName == "undefined") {
            var n = function(e) {
                ...
                while (t.offsetParent) {
                    t = t.offsetParent;
                    if (t != document.body && t.currentStyle["position"] != "static") {
                        break
                    }
            ...
            var i = function(e, t) {
                ...
                var o = 1;
                var u = 1;
                if (typeof e.style["msTransform"] != "undefined") {
                    return true
                }
                r(e);
                n = t.match(/rotate\((.*?)\)/);
                ...
                o *= c;
                u *= l;
                e.style.filter = (e.style.filter || "").replace(/progid:DXImageTransform\.Microsoft\.Matrix\([^)]*\)/, "") + ("progid:DXImageTransform.Microsoft.Matrix(" + "M11=" + i + ",M12=" + s + ",M21=" + o + ",M22=" + u + ",FilterType='bilinear',sizingMethod='auto expand')");
                var h = parseInt(e.style.width || e.width || 0);
                var p = parseInt(e.style.height || e.height || 0);
                var f = a * Math.PI / 180;
                var d = Math.abs(Math.cos(f));
                var v = Math.abs(Math.sin(f));
                var m = (h - (h * d + p * v)) / 2;
                var g = (p - (h * v + p * d)) / 2;
                e.style.marginLeft = Math.floor(m) + "px";
                e.style.marginTop = Math.floor(g) + "px";
                return true
            };
            var s = e.cssHooks.transform.set;
    ...
    elFinder.prototype.commands.rm = function() {
        ...
        this.getstate = function(t) {
            var n = this.fm;
            t = t || n.selected();
            return !this._disabled && t.length && e.map(t, function(e) {
                var t = n.file(e);
        ...
        this.exec = function(t) {
            ...
            e.each(s, function(e, t) {
                if (!t.phash) {
                    return !i.reject(["errRm", t.name, "errPerm"])
                }
                if (t.locked) {
                    return !i.reject(["errLocked", t.name])
                }
                if (t.hash == u) {
                    a = r.root(t.hash)
                }
    ...
    elFinder.prototype.commands.search = function() {
        ...
        this.exec = function(t) {
            ...
            n.getUI("toolbar").find("." + n.res("class", "searchbtn") + " :text").focus();
            return e.Deferred().reject()
        }
    };
    elFinder.prototype.commands.sort = function() {
        ...
        this.exec = function(t, n) {
            ...
            this.fm.setSort(n.type, n.order, n.stick);
            return e.Deferred().resolve()
        }
    };
    ...
    elFinder.prototype.commands.upload = function() {
        ...
        this.exec = function(n) {
            ...
            if (n && (n.input || n.files)) {
                return r.upload(n)
            }
            s = e.Deferred();
            u = e('<input type="file" multiple="true"/>').change(function() {
                i({
                    input: u[0]
                })
            });
            ...
            o = e('<div class="elfinder-upload-dialog-wrapper"/>').append(a);
            if (r.dragUpload) {
                f = e('<div class="ui-corner-all elfinder-upload-dropbox">' + r.i18n("dropFiles") + "</div>").prependTo(o).after('<div class="elfinder-upload-dialog-or">' + r.i18n("or") + "</div>")[0];
                f.addEventListener("dragenter", function(n) {
                    n.stopPropagation();
                    n.preventDefault();
                    e(f).addClass(t)
                }, false);
                f.addEventListener("dragleave", function(n) {
                    n.stopPropagation();
                    n.preventDefault();
                    e(f).removeClass(t)
                }, false);
